  ...
  return (
    <div className="mt-16">
      ...
      <div className="mt-16 lg:flex gap-5">
        <img
          className="lg:w-1/3 object-cover h-[450px] rounded-lg"
          src="/me1.jpg"
          alt=""
        />
        <img
      ...
      <p className="mt-16 text-base text-[#E8E5E5] leading-6">
        so, programming is my life forever about like that passsion. So i will
        try optimist way build projects which is user can uses more efficently.
      </p>
    </div>
  );
}
